            ...
            <div class="copy-wrapper" data-id="observedArea">
                ...
                <div class="copy-inner m-tickerspace">
                    ...
                    <div class="copy-wrapper__uploads">
						...
						<div class="copy-wrapper__text two m-bold">
							<p>
								<?php the_field('rr_page__section_1__instructions_text2'); ?>
							</p> 
						</div>
                        ...
                        if( $file4 ): ?>
                            <a class="c-button-1 download-btn" href="<?php the_field('rr_page__section_1__file_4'); ?>">
